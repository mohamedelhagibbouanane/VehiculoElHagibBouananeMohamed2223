 ...
 */
public class VehiculoElHagibBouananeMohamed2223 {
    ...
    public VehiculoElHagibBouananeMohamed2223 ()
    {
    }
    // Constructor con parámetro para iniciar todas las propiedades de la clase
    
    
    public VehiculoElHagibBouananeMohamed2223 (String nom, double precio, int stock)
    {
        this.nombre =nom;
        this.precio=precio;
        this.stock=stock;
